...
import bin.system.SettingsManager;
...
public class BookingForm extends javax.swing.JFrame {
    ...
    public boolean checkBooking() {
        for (int i = 0; i < tableReservation.getRowCount(); i++) {
            if (tableReservation.getValueAt(i, 3).equals(getTime()) && tableReservation.getValueAt(i, 1).equals(getTableNum())&&tableReservation.getValueAt(i, 2).toString().equals(getDate())) {
                JOptionPane.showMessageDialog(null, "Table Booking Exsist");
                return false;
            }
        }
        return true;
